            ...
            <div class="col-xl-3 d-none d-xl-block">
                <div class="sale-banner">
                    <a class="hover_effect1" href="#">
                        <img src="{{ asset('fontend/assets/images/shop_banner_img6.jpg') }}" alt="shop_banner_img6">
                    </a>
                </div>
            </div>
            <div class="col-xl-9">
                                ...
                                <div class="product_slider carousel_slider owl-carousel owl-theme dot_style1"
                                        ...
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="{{ asset('fontend/assets/images/el_img1.jpg') }}"
                                                        alt="el_img1">
                                                    <img class="product_hover_img"
                                                        src="{{ asset('fontend/assets/images/el_hover_img1.jpg') }}"
                                                        alt="el_hover_img1">
                                                </a>
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="{{ asset('fontend/assets/images/el_img2.jpg') }}"
                                                        alt="el_img2">
                                                    <img class="product_hover_img"
                                                        src="{{ asset('fontend/assets/images/el_hover_img2.jpg') }}"
                                                        alt="el_hover_img2">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            ...
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="{{ asset('fontend/assets/images/el_img3.jpg') }}"
                                                        alt="el_img3">
                                                    <img class="product_hover_img"
                                                        src="{{ asset('fontend/assets/images/el_hover_img3.jpg') }}"
                                                        alt="el_hover_img3">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="{{ asset('fontend/assets/images/el_img4.jpg') }}"
                                                        alt="el_img4">
                                                    <img class="product_hover_img"
                                                        src="{{ asset('fontend/assets/images/el_hover_img4.jpg') }}"
                                                        alt="el_hover_img4">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="{{ asset('fontend/assets/images/el_img5.jpg') }}"
                                                        alt="el_img5">
                                                    <img class="product_hover_img"
                                                        src="{{ asset('fontend/assets/images/el_hover_img5.jpg') }}"
                                                        alt="el_hover_img5">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            ...
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="{{ asset('fontend/assets/images/el_img6.jpg') }}"
                                                        alt="el_img6">
                                                    <img class="product_hover_img"
                                                        src="{{ asset('fontend/assets/images/el_hover_img6.jpg') }}"
                                                        alt="el_hover_img6">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                ...
                                <div class="product_slider carousel_slider owl-carousel owl-theme dot_style1"
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="{{ asset('fontend/assets/images/el_img7.jpg') }}"
                                                        alt="el_img7">
                                                    <img class="product_hover_img"
                                                        src="{{ asset('fontend/assets/images/el_hover_img7.jpg') }}"
                                                        alt="el_hover_img7">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            ...
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="{{ asset('fontend/assets/images/el_img8.jpg') }}"
                                                        alt="el_img8">
                                                    <img class="product_hover_img"
                                                        src="{{ asset('fontend/assets/images/el_hover_img8.jpg') }}"
                                                        alt="el_hover_img8">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="{{ asset('fontend/assets/images/el_img9.jpg') }}"
                                                        alt="el_img9">
                                                    <img class="product_hover_img"
                                                        src="{{ asset('fontend/assets/images/el_hover_img9.jpg') }}"
                                                        alt="el_hover_img9">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            ...
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="{{ asset('fontend/assets/images/el_img10.jpg') }}"
                                                        alt="el_img10">
                                                    <img class="product_hover_img"
                                                        src="{{ asset('fontend/assets/images/el_hover_img10.jpg') }}"
                                                        alt="el_hover_img10">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="{{ asset('fontend/assets/images/el_img11.jpg') }}"
                                                        alt="el_img11">
                                                    <img class="product_hover_img"
                                                        src="{{ asset('fontend/assets/images/el_hover_img11.jpg') }}"
                                                        alt="el_hover_img11">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="{{ asset('fontend/assets/images/el_img12.jpg') }}"
                                                        alt="el_img12">
                                                    <img class="product_hover_img"
                                                        src="{{ asset('fontend/assets/images/el_hover_img12.jpg') }}"
                                                        alt="el_hover_img12">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                        ...
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    ...
                                                    <img class="product_hover_img"
                                                        src="assets/images/el_hover_img2.jpg" alt="el_hover_img2">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                                        <li class="add-to-cart"><a href="#"><i
