<div class="modal-header">
    <h5 class="modal-title">Update Budget Information</h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
        &times;
    </button>
</div>
<div class="modal-body">
    <form action="{{ route("admin.laptop.budget.update", $model->id) }}" method="POST" class="ajax-form">
        @method('PATCH')
        <div class="row">

            <div class="col-md-12 form-group">
                <label for="name">Amount <span class="text-danger">*</span></label>
                <input type="text" name="name" id="name" class="form-control number" required value="{{ $model->name }}">
            </div>
