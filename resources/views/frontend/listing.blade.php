                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="brand-filter" class="accordion-collapse collapse show" aria-labelledby="flash-brand">
                                        <div class="accordion-body scrollbar">
                                            <ul class="list_brand">
                                                @php
                                                    $brands = App\Models\Brand::select('name', 'slug')->where('status', 1)->orderBy('name', 'ASC')->get();
                                                @endphp
                                                @foreach ($brands as $brand)
                                                    <li>
                                                        <div class="custome-checkbox">
                                                            <input class="form-check-input" type="checkbox" name="brand-{{ $brand->slug }}" id="brand-{{ $brand->slug }}" value="{{ $brand->slug }}">
                                                            ...
                                                            <ul class="list_brand">
                                                                @if ($attributes = $type->attributes->where('status', 1))
                                                                    @foreach ($attributes as $attr)
                                                                        <li>
                                                                            <div class="custome-checkbox">
                                                                                <input class="form-check-input" type="checkbox" name="brand-{{ $attr->id }}" id="brand-{{ $attr->id }}" value="{{ $attr->id }}">
                                                                                <label class="form-check-label" for="brand-{{ $attr->id }}"><span>{{ $attr->name }}</span></label>
                                                                            </div>
                                                                        </li>
                                                                    @endforeach
                                                                @endif
